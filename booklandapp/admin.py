...
class FeeStructureAdmin(admin.ModelAdmin):
    list_display = ("level", "tuition_fee_term_1", "tuition_fee_term_2", "tuition_fee_term_3",
                    "total_tuition_fee", "download_link")
    ...
    fieldsets = (
        ("Fee Information", {
            "fields": ("level", "tuition_fee_term_1", "tuition_fee_term_2",
                       "tuition_fee_term_3", "total_tuition_fee")
        }),
        ("PDF Document", {
